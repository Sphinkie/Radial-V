...
void MusicPlayer::initialize()
{
  ...
  if(!sd.begin(9, SPI_FULL_SPEED)) sd.initErrorHalt();   // SD_SEL,SPI_FULL_SPEED
...
// ******************************************************************************
// Cette fonction change de mode 'Différential output' (toggle).
// A utiliser si on a une sorte d'écho
// ******************************************************************************
